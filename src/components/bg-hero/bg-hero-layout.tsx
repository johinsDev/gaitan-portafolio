...
export function BgHeroLayout({ hero }: Props) {
  ...
  return <header className="relative full-width aspect-[16/5] overflow-hidden">
    {/* bg overlay */}
    ...
    {imageUrl && !hero.bgVideo && <Image src={imageUrl} alt="hero" fill className="object-cover" priority blurDataURL={image.asset.metadata.lqip} />}
  </header>
}
