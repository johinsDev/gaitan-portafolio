...
export function StatsLAyout({ data }: Props) {
  ...
  return <section className="py-12">
    ...
    {
      !!data.stats?.length && <div className="mt-8 lg:mt-16 grid lg:grid-cols-3 lg:*:border-r-black lg:*:border-r-[1.5px] lg:[&>*:first-child]:border-l-black lg:[&>*:first-child]:border-l-[1.5px]">
        {
          data?.stats?.map((stat, index) => {
            return <div key={index} className="py-4 lg:px-16 flex items-center lg:items-start lg:flex-col gap-4">
