    ...
    <div className="flex flex-col gap-4">
      ...
      <section className="flex flex-col gap-8 py-12">
        <div className="flex flex-col items-center lg:flex-row gap-8">
          <InputQueryParam type="text" placeholder="Pais" className="flex-1" name="country" />
          <InputQueryParam type="text" placeholder="Ciudad o Estado" className="flex-1" name="state" />
          <ButtonClearParams className="w-40 flex-shrink-0">Limpiar</ButtonClearParams>
        </div>
