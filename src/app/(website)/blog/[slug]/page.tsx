...
export default function BlogDetail() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <Image src="/real-estate.jpg" width={1200} height={450} alt="Real Estate" className="object-cover w-full aspect-square lg:aspect-[16/6] rounded-2xl" />


      <div className='text-sub-title leading-sub-title font-bold text-center mt-8'>Título de la entrada del blog (H1)</div>
